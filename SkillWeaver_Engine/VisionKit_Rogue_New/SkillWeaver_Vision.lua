-- SKILLWEAVER OPTICAL UPLINK v25.9 (HIGH-GAIN)
...
-- Gain increased to 0.73 to fix signal shortages (Health/Energy/CP)
-- Max Brightness = 0.08 + 0.73 = 0.81 (~206 RGB)
...
f:SetScript("OnUpdate", function()
    ...
    -- 1: SPEC HASH (DYNAMIC REAL-TIME)
    -- Queries API every frame. (ClassID * 10) + SpecID
    ...
    SetPixel(8, math.min(255, UnitPower("player", 4) * 50))
