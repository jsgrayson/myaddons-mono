# SKILLWEAVER VISION ENGINE v25.7
# PROTOCOL: DARK MATTER (HIGH GAIN)
...
class VisionSystem:
    ...
    def decode_differential(self, r, g, b):
        """
        LUA: Base(0.08) + (Val/255 * 0.5)
        Max Diff = 0.5 * 255 = 127.5
        """
        diff = int(b) - int(r)
        # Normalize: (Diff / 127.5) * 255
        val = (diff / 127.5) * 255.0
