-- SKILLWEAVER OPTICAL UPLINK v3.1 (HIGH-GAIN)
...
-- DIFFERENTIAL ENCODER (MAX GAIN 0.90)
-- Max Brightness = 0.08 + 0.90 = 0.98 (Near White Max)
-- This provides maximum separation between values.
...
f:SetScript("OnUpdate", function()
    ...
    -- 1: SPEC HASH (DOUBLE PRECISION - HARDCODED)
    -- Class: Rogue (4)
    -- Spec: Assassination (1)
    -- Value: 41.0
    SetPixel(1, 41.5) -- +0.5 for centering
