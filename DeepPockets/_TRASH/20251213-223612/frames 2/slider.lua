...
function slider:CreateDropdownSlider()
  ...
  local f = CreateFrame("Frame", "DeepPocketsSliderParent" .. sliderCount)
  Mixin(f, UIDropDownCustomMenuEntryMixin)
  f:SetSize(100, 20)

  local s = CreateFrame("Slider", "DeepPocketsSlider" .. sliderCount, f, "OptionsSliderTemplate") --[[@as slider]]
  s:SetAllPoints()
