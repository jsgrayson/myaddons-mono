...
-- DeepPockets_ToggleSearch toggles the search view. This function is used in the
-- search key bind.
function DeepPockets_ToggleSearch()
  local ctx = context:New('DeepPockets_ToggleSearch')
...
function searchBox:Create(ctx, parent)
  ...
  local f = CreateFrame("Frame", "DeepPocketsSearchFrame", UIParent, "DeepPocketsSearchPanelTemplate") --[[@as Frame]]
  f:SetSize(400, 75)
  ...
  local helpText = textBox:CreateFontString("DeepPocketsSearchHelpText", "ARTWORK", "GameFontDisableLarge")
