...
---@class DeepPocketsSectionConfigItemFrame: Frame
---@field item ItemRow
...
---@param frame DeepPocketsSectionConfigItemFrame
---@param elementData table
...
function sectionItemList:Create(parent)
  ...
  sc.content:SetupDataSource("DeepPocketsSectionConfigItemFrame", function(f, data)
    ---@cast f DeepPocketsSectionConfigItemFrame
