...
function itemFrame:OnEnable()
	self.emptyItemTooltip = CreateFrame("GameTooltip", "DeepPocketsEmptySlotTooltip", UIParent, "GameTooltipTemplate") --[[@as GameTooltip]]
...
function itemFrame:_DoCreate(_)
	...
	local name = format("DeepPocketsItemButton%d", buttonCount)
